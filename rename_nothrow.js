...
class refactor_discover_UsageCollector {
	...
	parseFile(content,context) {
		...
		try {
			...
			if(((_g2) instanceof hxparse_ParserError)) {
				let e = _g2;
				console.log("src/refactor/discover/UsageCollector.hx:33:","failed to parse " + context.fileName + " - ParserError: " + Std.string(e) + " (" + Std.string(e.pos) + ")");
			} else if(((_g2) instanceof haxeparser_LexerError)) {
				let e = _g2;
				console.log("src/refactor/discover/UsageCollector.hx:35:","failed to parse " + context.fileName + " - LexerError: " + Std.string(e.msg) + " (" + Std.string(e.pos) + ")");
			} else {
				let e = _g1;
				console.log("src/refactor/discover/UsageCollector.hx:37:","failed to parse " + context.fileName + " - " + e.details());
			}
		}
	}
	parseFileWithTokens(root,context) {
		...
		try {
			...
			console.log("src/refactor/discover/UsageCollector.hx:57:","failed to parse " + context.fileName + " - " + e.details());
		}
	}
	isCached(context) {
		if(context.cache != null) {
	...
	readInterpolatedFragment(context,identifier,text,offset) {
		...
		try {
			...
			if(((_g2) instanceof hxparse_ParserError)) {
				let e = _g2;
				console.log("src/refactor/discover/UsageCollector.hx:367:","failed to parse " + context.fileName + " - ParserError: " + Std.string(e) + " (" + Std.string(e.pos) + ")");
			} else if(((_g2) instanceof haxeparser_LexerError)) {
				let e = _g2;
				console.log("src/refactor/discover/UsageCollector.hx:369:","failed to parse " + context.fileName + " - LexerError: " + Std.string(e.msg) + " (" + Std.string(e.pos) + ")");
			} else {
				let e = _g1;
				console.log("src/refactor/discover/UsageCollector.hx:371:","failed to parse " + context.fileName + " - " + e.details());
			}
		}
	}
